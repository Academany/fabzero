...
There could be multiple scenarios where we may have to skip using hardware PWM. Perhaps our design doesn't allow PWM pins to be used. May be we may need better control over Timer0 based PWM.
...
## Where?
 TODO show use cases, breathing LED in gadgets, Dimming Light, LCD backlight, fan speed control, DC-DC controllers.   Dimmers
